...
model resultatsTravail_RepriseLabour
...
global{
	action initialisationEcritureFichiersTravail_RepriseLabour{		
		do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers travail Reprise Labour...';		
		
		create resultatsTravail_RepriseLabour number: 1{
			do initialisation();
...
species resultatsTravail_RepriseLabour parent: ecritureResultats{
	/*
	 * @Overwrite
	 */
	 string initialisationJournalier{			
		...
		nomFichierJournalier <- cheminRelatifDuDossierDeSortieDeSimulation +'/Agri_heuresRepriseLabour'+ nomDeLaSimulation + '.csv';
	 ...
	 */		 
	 string ecritureJournaliere{		 	
		...
		ask listeAgriculteurs{
			data <- data + ';' + heuresRepriseLabour with_precision 1;
		}
