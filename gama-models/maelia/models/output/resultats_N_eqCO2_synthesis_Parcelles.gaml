...
model resultats_N_eqCO2_synthesis_Parcelles
...
global{
      action initialisationEcritureFichierresultats_N_eqCO2_synthesis_Parcelles {
            do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers resultats_N_eqCO2_synthesis_Parcelles';           
            
            create resultats_N_eqCO2_synthesis_Parcelles number: 1{
                  do initialisation();
...
species resultats_N_eqCO2_synthesis_Parcelles parent: ecritureResultats {
      /*
            * @Overwrite
            */
            
      string initialisationFinAnnuel {   
		nomFichierFinAnnuel <- cheminRelatifDuDossierDeSortieDeSimulation +'/resultats_N_eqCO2_synthesis_Parcelles'+ nomDeLaSimulation + '.csv';  
      ...
      string ecritureFinAnnuelle {
            ...
            loop p over: listeParcelles {
            	data <- data + ";" + parcelleAqYieldNC(p).eqCO2_synthesis_cumul;
			}
            return data;      
      }
}
