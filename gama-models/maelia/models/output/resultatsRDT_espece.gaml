...
species resultatsRDT_espece parent: ecritureResultats{
	/*
	 * @Overwrite
	 */
	 string initialisationFinAnnuel{	
		nomFichierFinAnnuel <- cheminRelatifDuDossierDeSortieDeSimulation +'/rendements_espece'+ nomDeLaSimulation + '.csv';	
	 ...
	 string ecritureFinAnnuelle{			 		 			 		
		...
		loop espece over: listeEspecesCultiveesParOrdreSaisie{ 										
			...
			loop agri over: listeAgriculteurs{
				//write agri.idAgriculteur ;
				//write agri.listMemoire;
