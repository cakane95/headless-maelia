...
global{
	action initialisationEcritureFichiersAS_debit{
		...
		create resultatsAS_debit number: 1{
			do initialisation();
...
species resultatsAS_debit parent: ecritureResultats{
	/*
	 * @Overwrite
	 */
	 string initialisationJournalier{			
		...
		nomFichierJournalier <- cheminRelatifDuDossierDeSortieDeSimulation +'/debit'+ nomDeLaSimulation + '.csv';
