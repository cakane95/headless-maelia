...
model resultatsTravail_Recolte
...
global{
	action initialisationEcritureFichiersTravail_Recolte{		
		do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers travail Recolte...';		
		
		create resultatsTravail_Recolte number: 1{
			do initialisation();
...
species resultatsTravail_Recolte parent: ecritureResultats{
	/*
	 * @Overwrite
	 */
	 string initialisationJournalier{			
		...
		nomFichierJournalier <- cheminRelatifDuDossierDeSortieDeSimulation +'/Agri_heuresRecolte'+ nomDeLaSimulation + '.csv';
	 ...
	 */		 
	 string ecritureJournaliere{		 	
		...
		ask listeAgriculteurs{
			data <- data + ';' + heuresRecolte with_precision 1;
		}
