...
model resultats_N_Nmin_som_res_Parcelles
...
global{
      action initialisationEcritureFichiersresultats_N_Nmin_som_res_Parcelles{
            do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers resultats_N_Nmin_som_res_Parcelles';           
            
            create resultats_N_Nmin_som_res_Parcelles number: 1{
                  do initialisation();
...
species resultats_N_Nmin_som_res_Parcelles parent: ecritureResultats {
      /*
            * @Overwrite
            */
            
      string initialisationFinAnnuel {   
		nomFichierFinAnnuel <- cheminRelatifDuDossierDeSortieDeSimulation +'/resultats_N_Nmin_som_res_Parcelles'+ nomDeLaSimulation + '.csv';  
      ...
      string ecritureFinAnnuelle {
            ...
            loop p over: listeParcelles {
            	data <- data + ";" + parcelleAqYieldNC(p).Nmin_som_res_cumul;
			}
            return data;      
      }
}
