...
global{
	action initialisationEcritureFichiersTravail_Labour{		
		do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers travail Labour...';		
		
		create resultatsTravail_Labour number: 1{
			do initialisation();
...
species resultatsTravail_Labour parent: ecritureResultats{
	/*
	 * @Overwrite
	 */
	 string initialisationJournalier{			
		...
		nomFichierJournalier <- cheminRelatifDuDossierDeSortieDeSimulation +'/Agri_heuresLabour'+ nomDeLaSimulation + '.csv';
	 ...
	 */		 
	 string ecritureJournaliere{		 	
		...
		ask listeAgriculteurs{
			data <- data + ';' + heuresLabour with_precision 1;
		}
