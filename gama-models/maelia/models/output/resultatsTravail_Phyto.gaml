...
global{
	action initialisationEcritureFichiersTravail_Phyto{		
		do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers travail Phyto...';		
		
		create resultatsTravail_Phyto number: 1{
			do initialisation();
...
species resultatsTravail_Phyto parent: ecritureResultats{
	/*
	 * @Overwrite
	 */
	 string initialisationJournalier{			
		...
		nomFichierJournalier <- cheminRelatifDuDossierDeSortieDeSimulation +'/Agri_heuresPhyto'+ nomDeLaSimulation + '.csv';
	 ...
	 */		 
	 string ecritureJournaliere{		 	
		...
		ask listeAgriculteurs{
			data <- data + ';' + heuresPhyto with_precision 1;
		}
