...
model resultats_N_N2O_Parcelles
...
global{
      action initialisationEcritureFichiersresultats_N_N2O_Parcelles {
            do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers resultats_N_N2O_Parcelles';           
            
            create resultats_N_N2O_Parcelles number: 1{
                  do initialisation();
...
species resultats_N_N2O_Parcelles parent: ecritureResultats {
      /*
            * @Overwrite
            */
            
      string initialisationFinAnnuel {   
		nomFichierFinAnnuel <- cheminRelatifDuDossierDeSortieDeSimulation +'/resultats_N_N2O_Parcelles'+ nomDeLaSimulation + '.csv';  
      ...
      string ecritureFinAnnuelle {
            ...
            loop p over: listeParcelles {
            	data <- data + ";" + parcelleAqYieldNC(p).N_n2o_cumul;
			}
            return data;      
      }
}
