...
***************************************************************************/
/**
 *  resultatsTravail_itk
 *  Author: Romain Lardy
 *  Description: 
 */

model resultatsTravail_itk
...
global{
	action initialisationEcritureFichiersTravail_itk{
		do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers Travail par ITK...';		
		
		create resultatsTravail_itk number: 1{
			do initialisation();
...
species resultatsTravail_itk parent: ecritureResultats{
	/*
	 * @Overwrite
	 */
	 string initialisationFinAnnuel{	
		nomFichierFinAnnuel <- cheminRelatifDuDossierDeSortieDeSimulation +'/travail_itk'+ nomDeLaSimulation + '.csv';	
