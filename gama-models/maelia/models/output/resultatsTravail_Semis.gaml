...
global{
	action initialisationEcritureFichiersTravail_Semis{		
		do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers travail Semis...';		
		
		create resultatsTravail_Semis number: 1{
			do initialisation();
...
species resultatsTravail_Semis parent: ecritureResultats{
	/*
	 * @Overwrite
	 */
	 string initialisationJournalier{			
		...
		nomFichierJournalier <- cheminRelatifDuDossierDeSortieDeSimulation +'/Agri_heuresSemis'+ nomDeLaSimulation + '.csv';
	 ...
	 */		 
	 string ecritureJournaliere{		 	
		...
		ask listeAgriculteurs{
			data <- data + ';' + heuresSemis with_precision 1;
		}
