...
global{
	action initialisationEcritureFichiersTravail_Binage{		
		do ecritureConsolePourDebug isAfficherTemps: true chaineAEcrire: 'Initialisation ecriture fichiers travail Binage...';		
		
		create resultatsTravail_Binage number: 1{
			do initialisation();
...
species resultatsTravail_Binage parent: ecritureResultats{
	/*
	 * @Overwrite
	 */
	 string initialisationJournalier{			
		...
		nomFichierJournalier <- cheminRelatifDuDossierDeSortieDeSimulation +'/Agri_heuresBinage'+ nomDeLaSimulation + '.csv';
	 ...
	 */		 
	 string ecritureJournaliere{		 	
		...
		ask listeAgriculteurs{
			data <- data + ';' + heuresBinage with_precision 1;
		}
