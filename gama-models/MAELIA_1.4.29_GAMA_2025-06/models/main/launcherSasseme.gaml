...
experiment simulationBase type: gui {
 ...
 /* ---------------------------------- SORTIES ------------------------------------------------------------------*/
	...
	display Culture autosave: false type: java2D {  			
		...
		chart name: 'Eau dans le sol' size: {0.5, 0.5} position: {0.0, 0.0} type: series background: rgb('white') {
				...
				data 'Hr'      value: parcelleAqYield(first(listeParcelles)).Hr style: line color: rgb('blue');
			}
		chart name: 'Stress hydrique' size: {0.5, 0.5} position: {0.0, 0.5} type: series background: rgb('white') {
				//data 'kc' value: parcelleAqYieldNC(first(listeParcelles)).getKc() style: line color: rgb('blue');
				//data 'kc à floraison' value: parcelleAqYield(first(listeParcelles)).getKc_flo() style: line color: rgb('red');
				data 'Stress hydrique (déficit de transpi.)' value: mean(list(cultureAqYield) collect each.indiceSatifactionHydrique) style: line color: rgb('blue');
			}
		chart name: "Précipitation" size: {0.5,0.5} position: {0.5,0.0} type: series background: rgb('white') {
		            ...
		            data 'Evapotranspiration' value: mean(list(zoneMeteo) collect each.etp) style: line color: rgb('red');                    
		}
	...
	display biomasse autosave: false type: java2D { 

		chart name: "KC" size: {0.5,0.5} position: {0.5, 0.5} type: series background: rgb('white') {
		
		              data 'DKc' value: mean(list(cultureAqYield) collect each.kc) style: line color: rgb('red');
		           // data 'echV' value: mean(list(cultureAqYield) collect each.echV) style: line color: rgb('green');
		           data 'Transpi sol' value: mean(list(parcelleAqYield) collect each.transpirationR) style: line color: rgb("blue");
